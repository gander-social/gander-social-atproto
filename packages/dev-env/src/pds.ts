...
import { createSecretKeyObject } from '@gander-social-atproto/pds'
...
export class TestPds {
  ...
  static async create(config: PdsConfig): Promise<TestPds> {
    ...
    const env: pds.ServerEnvironment = {
      ...
      gndrAppViewUrl: 'https://appview.invalid',
      gndrAppViewDid: 'did:example:invalid',
      gndrAppViewCdnUrlPattern: 'http://cdn.appview.com/%s/%s/%s',
      ...
      homeUrl: 'https://gander.social/',
      termsOfServiceUrl: 'https://gander.social/about/support/tos',
      privacyPolicyUrl: 'https://gander.social/about/support/privacy-policy',
