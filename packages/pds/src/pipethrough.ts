...
export const PRIVILEGED_METHODS = new Set<string>([
  ...
  ids.ChatGndrConvoGetConvo,
  ids.ChatGndrConvoGetConvoForMembers,
  ids.ChatGndrConvoGetLog,
  ids.ChatGndrConvoGetMessages,
  ids.ChatGndrConvoLeaveConvo,
  ids.ChatGndrConvoListConvos,
  ids.ChatGndrConvoMuteConvo,
  ids.ChatGndrConvoSendMessage,
