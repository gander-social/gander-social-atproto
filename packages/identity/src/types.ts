import { DidDocument } from '@gander-social-atproto/common-web'

export { didDocument } from '@gander-social-atproto/common-web'
export type { DidDocument } from '@gander-social-atproto/common-web'
