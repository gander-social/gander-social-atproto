# @gander-social-atproto/bsync: Synchronizing Service for the Gander AppView

This is an optional service that may be used to synchronize certain state between otherwise independent AppViews.

[![NPM](https://img.shields.io/npm/v/@gander-social-atproto/bsync)](https://www.npmjs.com/package/@gander-social-atproto/bsync)
