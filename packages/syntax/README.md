# @gander-social-atproto/syntax: validation helpers for identifier strings

Validation logic for [atproto](https://atproto.com) identifiers - DIDs, Handles, NSIDs, and AT URIs.

[![NPM](https://img.shields.io/npm/v/@gander-social-atproto/crypto)](https://www.npmjs.com/package/@gander-social-atproto/syntax)
