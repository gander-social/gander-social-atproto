...
Shared TypeScript code for other `@gander-social-atproto/*` packages. This package is oriented towards writing servers,
and is not designed to be browser-compatible.

[![NPM](https://img.shields.io/npm/v/@gander-social-atproto/common)](https://www.npmjs.com/package/@gander-social-atproto/common)
