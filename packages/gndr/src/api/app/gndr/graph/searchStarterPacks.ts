...
import { QueryParams } from '../../../../lexicon/types/app/gndr/graph/searchStarterPacks'
import {
  HydrationFnInput,
  PresentationFnInput,
  RulesFnInput,
...
export default function (server: Server, ctx: AppContext) {
  ...
  server.app.gndr.graph.searchStarterPacks({
...
const skeleton = async (inputs: SkeletonFnInput<Context, Params>) => {
  ...
  if (ctx.searchAgent) {
    ...
    const { data: res } =
      await ctx.searchAgent.app.gndr.unspecced.searchStarterPacksSkeleton({
        q,
