...
import { QueryParams } from '../../../../lexicon/types/app/gndr/graph/getSuggestedFollowsByActor'
import {
  HydrationFnInput,
  PresentationFnInput,
  RulesFnInput,
...
export default function (server: Server, ctx: AppContext) {
  ...
  server.app.gndr.graph.getSuggestedFollowsByActor({
...
const skeleton = async (input: SkeletonFnInput<Context, Params>) => {
  ...
  if (ctx.suggestionsAgent) {
    const res =
      await ctx.suggestionsAgent.api.app.gndr.unspecced.getSuggestionsSkeleton(
        {
