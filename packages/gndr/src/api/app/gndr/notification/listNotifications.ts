...
import { isRecord as isPostRecord } from '../../../../lexicon/types/app/gndr/feed/post'
import { QueryParams } from '../../../../lexicon/types/app/gndr/notification/listNotifications'
import {
  HydrationFnInput,
  PresentationFnInput,
  RulesFnInput,
...
export default function (server: Server, ctx: AppContext) {
  ...
  server.app.gndr.notification.listNotifications({
