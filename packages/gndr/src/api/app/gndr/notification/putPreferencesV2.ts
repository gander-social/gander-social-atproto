...
import { HandlerInput } from '../../../../lexicon/types/app/gndr/notification/putPreferencesV2'
import { GetNotificationPreferencesResponse } from '../../../../proto/gndr_pb'
import { Namespaces } from '../../../../stash'
import { protobufToLex } from './util'

export default function (server: Server, ctx: AppContext) {
  server.app.gndr.notification.putPreferencesV2({
