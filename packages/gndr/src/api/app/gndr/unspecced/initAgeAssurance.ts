...
import { InputSchema } from '../../../../lexicon/types/app/gndr/unspecced/initAgeAssurance'
import { httpLogger as log } from '../../../../logger'
import { ActorInfo } from '../../../../proto/gndr_pb'
import { KwsExternalPayload } from '../../../kws/types'
import { createStashEvent, getClientUa } from '../../../kws/util'

export default function (server: Server, ctx: AppContext) {
  server.app.gndr.unspecced.initAgeAssurance({
