...
import { TrendingTopic } from '../../../../lexicon/types/app/gndr/unspecced/defs'
...
export default function (server: Server, ctx: AppContext) {
  ...
  server.app.gndr.unspecced.getTrendingTopics({
...
const skeleton = async (input: SkeletonFnInput<Context, Params>) => {
  ...
  if (ctx.topicsAgent) {
    const res = await ctx.topicsAgent.app.gndr.unspecced.getTrendingTopics(
      {
        limit: params.limit,
