...
import { SkeletonTrend } from '../../../../lexicon/types/app/gndr/unspecced/defs'
import { QueryParams } from '../../../../lexicon/types/app/gndr/unspecced/getTrendingTopics'
import {
  HydrationFnInput,
  PresentationFnInput,
  RulesFnInput,
...
export default function (server: Server, ctx: AppContext) {
  ...
  server.app.gndr.unspecced.getTrends({
...
const skeleton = async (input: SkeletonFnInput<Context, Params>) => {
  ...
  if (ctx.topicsAgent) {
    const res = await ctx.topicsAgent.app.gndr.unspecced.getTrendsSkeleton(
      {
        limit: params.limit,
