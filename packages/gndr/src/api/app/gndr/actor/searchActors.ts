...
import { QueryParams } from '../../../../lexicon/types/app/gndr/actor/searchActors'
import {
  HydrationFnInput,
  PresentationFnInput,
  RulesFnInput,
...
export default function (server: Server, ctx: AppContext) {
  ...
  server.app.gndr.actor.searchActors({
...
const skeleton = async (inputs: SkeletonFnInput<Context, Params>) => {
  ...
  if (ctx.searchAgent) {
    ...
    const { data: res } =
      await ctx.searchAgent.app.gndr.unspecced.searchActorsSkeleton({
        q: term,
