# @gander-social-atproto/gndr: Gander AppView Service

TypeScript implementation of the `app.gndr` Lexicons backing the https://gndr.app microblogging application.

[![NPM](https://img.shields.io/npm/v/@gander-social-atproto/bsky)](https://www.npmjs.com/package/@gander-social-atproto/bsky)
