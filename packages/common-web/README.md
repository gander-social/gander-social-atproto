...
Shared TypeScript code for other `@gander-social-atproto/*` packages, which is web-friendly (runs in-browser).

[![NPM](https://img.shields.io/npm/v/@gander-social-atproto/common)](https://www.npmjs.com/package/@gander-social-atproto/common-web)
